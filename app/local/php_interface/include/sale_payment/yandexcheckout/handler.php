		...
		PaySystem\IRecurring
{
	...
	private function getReturnUrl(Payment $payment)
	{
		return $this->getBusinessValue($payment, 'YANDEX_CHECKOUT_RETURN_URL') ?
            $this->getReturnUrlCheck($payment) :
     ...
     */
    private function getReturnUrlCheck (Payment $payment)
    {
        ...
        $url =  str_replace(
            ...
            $this->getBusinessValue($payment, 'YANDEX_CHECKOUT_RETURN_URL')
        );

        return mb_substr($url, 0, 128);
    }
