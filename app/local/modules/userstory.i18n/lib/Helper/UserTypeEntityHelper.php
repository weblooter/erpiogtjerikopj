...
class UserTypeEntityHelper extends Helper
{
    ...
    public function addUserTypeEntity($entityId, $fieldName, $fields)
    {
        ...
        $this->throwException(
            __METHOD__,
            Loc::getMessage(
                self::MESSAGE_PREFIX . 'ERR_USERTYPE_NOT_ADDED',
                [
                    '#NAME#' => $fieldName,
                ]
            )
    ...
    public function updateUserTypeEntity($fieldId, $fields)
    {
        ...
        $this->throwException(
            __METHOD__,
            Loc::getMessage(
                self::MESSAGE_PREFIX . 'ERR_USERTYPE_NOT_UPDATED',
                [
                    '#NAME#' => $fieldId,
                ]
            )
    ...
    public function deleteUserTypeEntityIfExists($entityId, $fieldName)
    {
        ...
        $this->throwException(
            __METHOD__,
            Loc::getMessage(
                self::MESSAGE_PREFIX . 'ERR_USERTYPE_NOT_DELETED',
                [
                    '#NAME#' => $fieldName,
                ]
            )
    ...
    protected function prepareExportUserTypeEntity($fields)
    {
        ...
        try {
            ...
            $userTypeMessage = Loc::getMessage(
                self::MESSAGE_PREFIX . 'ERR_USERTYPE_EXPORT',
